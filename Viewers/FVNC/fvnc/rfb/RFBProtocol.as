...
public class RFBProtocol extends Socket {
	 ...
	 */
	public function readServerInit():Object
	{
		var serverInit:Object = new Object();
		...
		serverInit.pixelFormat = pixelFormat;
		...
		var nameLength:int = readInt();
		var name:ByteArray = new ByteArray();
		readBytes( name, 0, nameLength );
		
		// Save the server name in the server settings
		serverInit.name = name.toString();
